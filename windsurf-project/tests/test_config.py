...
class TestConfigManager:
    ...
    def sample_config(self):
        ...
        return {
            ...
            "credentials": {
                "aws": {"access_key_id": "test_access_key", "secret_access_key": "test_secret_key"},
                "datadog": {"api_key": "test_datadog_key", "app_key": "test_datadog_app_key"},
                "splunk": {"username": "test_user", "password": "test_password"},
                "ai": {
