...
class TestTestRunner:
    ...
    def test_runner(self, config_manager):
        ...
        return TestRunner(config_manager)
    ...
    async def test_run_test_multiple_targets(self, test_runner):
        ...
        with patch.object(test_runner.test_engine, 'execute_http_test') as mock_http, \
             patch.object(test_runner.test_engine, 'execute_database_test') as mock_db:
