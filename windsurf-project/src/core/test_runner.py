...
from utils.logger import TestLogger, get_logger

from .test_engine import LoadTestEngine
...
class LoadTestRunner:
    ...
    def run_test_sync(self, test_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                results = loop.run_until_complete(self._execute_test_async(test_config))
            finally:
                loop.close()
