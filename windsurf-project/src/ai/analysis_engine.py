...
class AIAnalysisEngine:
    ...
    def analyze_test_results(self, test_results: Dict[str, Any], 
                           raw_data: Optional[List[Dict[str, Any]]] = None) -> Dict[str, Any]:
        """
    ...
    def _create_analysis_prompt(self, test_results: Dict[str, Any], 
                               raw_data: Optional[List[Dict[str, Any]]] = None) -> str:
...
"""
    ...
    def _generate_basic_analysis(self, test_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = "Basic analysis of test - " + ", ".join(summary_parts) if summary_parts else "No data available"
        ...
        if total_requests > 0:
            ...
            if percentiles:
                ...
                key_findings.extend([
                    f"95th percentile: {p95:.3f}s",
                    f"99th percentile: {p99:.3f}s"
                ])
    ...
    def _assess_response_times(self, avg_response_time: float, percentiles: Dict[str, float]) -> str:
    ...
    def compare_test_runs(self, test_runs: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for run in test_runs:
            comparison_data.append({
                ...
                "success_rate": (run.get("successful_requests", 0) / run.get("total_requests", 1)) * 100,
